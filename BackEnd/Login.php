...
$query2 = "SELECT * FROM post WHERE userid IN ( SELECT userid FROM frndlist WHERE followers = '".$_GET['id']."' ) OR userid = '".$_GET['id']."' ORDER BY id DESC LIMIT 0 , 10";
}
if(isset($_GET['start'])) {
$query2 = "SELECT * FROM(SELECT * FROM post WHERE (id > '".$_GET['start']."') AND (userid = '".$_GET['id']."' OR userid IN (SELECT userid FROM frndlist WHERE followers = '".$_GET['id']."'))) AS a ORDER BY id DESC ";
}
if(isset($_GET['close'])) {
$query2 = "SELECT * FROM(SELECT * FROM post WHERE (id < '".$_GET['close']."') AND (userid = '".$_GET['id']."' OR userid IN (SELECT userid FROM frndlist WHERE followers = '".$_GET['id']."'))) AS a ORDER BY id DESC LIMIT 10";
}
...
$subject = "Home";
$message = "Account Open by userid - ".$_GET['id']." .                                             Cookzz production &copy; 2015";
